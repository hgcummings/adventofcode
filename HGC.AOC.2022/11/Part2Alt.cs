...
public class Part2Alt : ISolution
{
    ...
    public class Monkey
    {
        ...
        public Monkey(MonkeyData data)
        {
            ...
            opScript = CSharpScript.Create<long>(data.Operation, globalsType: typeof(OpVars));
        ...
        {
            return opScript.RunAsync(new OpVars { old = old }).Result.ReturnValue;
        }
