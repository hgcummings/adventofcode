...
async function processLineByLine() {
    ...
    for (let duration = 1; duration <= 2503; ++duration) {
        ...
        const roundWinner = _.maxBy(reindeer, deer => deer.totalDistance);
        roundWinner.points += 1;
    }

    console.log(_.maxBy(reindeer, deer => deer.points));
}
